namespace Katamari
    module Items =
        ...
        let rcrayon = { name="Red Crayon"; description="A red crayon. This is not lipstick. Grils, be careful."; size=4.2 }
        let coin = { name="5 yen"; description="People believe this will bring them good luck."; size=2.8 }
        let hairpin = { name="Hairpin"; description="Used to fix hairstyles. Also teh name for a sharp curve, but you can't put that on your head."; size=4.5 }
        let pachinko = { name="Pachinko Ball"; description="The usually disappear very quickly when playing Pachinko..."; size=4.7 }
